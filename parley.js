...
var ChatRoom, Conversation, Handlebars, Message, MessageView, UserView, app, chat_room_template;
...
ChatRoom = (function() {
  ...
  ChatRoom.prototype.add_users_to_convo = function(e) {
    ...
    this.$discussion.append('<li><h1>Add Users to Conversation</h1></li>');
  ...
  ChatRoom.prototype.confirm_new_convo_params = function(e) {
    var conversation, convo, convo_exists, convo_id, convo_partners_image_urls, new_convo_partners, user, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
    e.preventDefault();
...
},{"./app.coffee":19,"./conversation_model.coffee":22,"./message_model.coffee":23,"./message_view.coffee":24,"./templates/chat_room.hbs":27,"./user_view.coffee":35,"hbsfy/runtime":18}],21:[function(require,module,exports){
...
CommandCenter = (function() {
  ...
  CommandCenter.prototype.refresh_convo_creation = function() {
    var user, view, _i, _len, _ref;
    this.new_convo_params = [];
    $('.parley div.controller-view').children().remove();
    $('.parley div.controller-view').append('<li><h1>Start Conversation</h1></li>');
...
UserView = (function() {
  function UserView(current_user, current_view) {
    ...
    if (this.current_view.constructor.name === "ChatRoom") {
      ...
      console.log(this.current_view.convo.convo_partners);

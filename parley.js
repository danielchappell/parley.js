...
UserView = (function() {
  ...
  UserView.prototype.open_conversation = function() {
    var chat_window, conversation, convo, convo_exists, convo_id, _i, _j, _len, _len1, _ref, _ref1;
    console.log(app.open_conversations);
    convo_id = [app.me.image_url, this.current_user.image_url].sort().join();
    _ref = app.open_conversations;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      convo = _ref[_i];
      if (convo_id === convo.message_filter) {
        return;
      }
    }
    convo_exists = false;

...
CommandCenter = (function() {
  ...
  CommandCenter.prototype.log_in = function() {
    ...
    $('.parley div.controller-bar a.active-users').on('click', this.toggle_current_users);
  ...
  CommandCenter.prototype.toggle_user_settings = function() {
    return console.log("USERSETTINGS!!");
  };
...
UserView = (function() {
  ...
  UserView.prototype.render = function() {
    this.$element.html(current_user_template(this.current_user));
